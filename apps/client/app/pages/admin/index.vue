    ...
    <div class="space-y-10 divide-y divide-gray-900/10 pt-10">
      ...
      >
        <button
          ...
          ref="dropZoneRef"
          type="button"
          class="col-span-full rounded-lg border-2 border-dashed border-gray-300 p-12 text-center hover:border-gray-400 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-none"
        >
