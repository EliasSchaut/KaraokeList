  ...
  <Modal ref="modal" own_buttons>
    <div>
      ...
      <div class="my-3 text-center sm:mt-5">
        <DialogTitle
          as="h3"
          class="text-secondary-900 text-base leading-6 font-semibold dark:text-white"
      ...
      <Form :submit="report">
        ...
        >
          ...
          <button
            type="button"
            class="text-secondary-900 ring-secondary-300 hover:bg-secondary-50 mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold shadow-sm ring-1 ring-inset sm:col-start-1 sm:mt-0"
            @click="hide()"
          >
