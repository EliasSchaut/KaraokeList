<template>
  <div>
    ...
    <div
      :class="[
        inside_label != null
          ? 'flex ring-1 ring-gray-300 ring-inset focus:ring-2 focus:ring-indigo-600 focus:ring-inset dark:bg-white/5 dark:ring-white/10 dark:focus:ring-indigo-500'
          : '',
    ...
    >
      ...
      <span
        ...
        class="flex items-center pl-3 text-gray-500 select-none sm:text-sm dark:text-gray-300"
        >{{ inside_label }}</span
      >
      <input
        @input="
        ...
        :class="[
          ...
          inside_label != null
            ...
            : 'w-full ring-1 ring-gray-300 ring-inset focus:ring-2 focus:ring-indigo-600 focus:ring-inset dark:bg-white/5 dark:ring-white/10 dark:focus:ring-indigo-500',
          'block rounded-md border-0 py-1.5 text-gray-900 placeholder:text-gray-400 sm:text-sm sm:leading-6 dark:text-white',
        ]"
